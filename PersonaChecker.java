...
public class PersonaChecker {
    ...
    public boolean hasArmUpAndNoTie(Persona p) { 
        return (!p.getHasTie() && p.getIsArmUp());
    }
    
    public boolean hasTieOrBeltButNotBoth(Persona p){
        return (p.getHasTie() ^ p.getHasBelt());
    }
    
    
    
    /***********************************************************************
     * End of solution for step 5
     ***********************************************************************/
    
    /***********************************
       Cow                            */
    /* Expected output for the main above (tests for Unicorn, Fox, and Lion only):
